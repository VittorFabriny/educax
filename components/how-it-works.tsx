...
export function HowItWorks() {
  return (
    <div className="px-20 py-20 bg-[var(--color-bg-alt)]/50">
      ...
      <div className="flex items-center justify-center gap-8 ">
        <div className="relative">
          <div className="flex flex-col gap-4 items-center px-8 py-30 shadow-xl hover:shadow-2xl text-center rounded-b-2xl">
            <div className="flex items-center justify-center w-16 h-16 bg-[var(--primary-color)]/10 rounded-full">
              <Search size={40} className="text-[var(--primary-color)]" />
            </div>
          ...
          <div>
            <div className="absolute right-10 top-26 w-10 h-10 bg-[var(--primary-color)] rounded-full text-white flex items-center justify-center">
              1
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="flex flex-col gap-4 items-center px-8 py-30 shadow-xl hover:shadow-2xl text-center rounded-b-2xl">
            <div className="flex items-center justify-center w-16 h-16 bg-[var(--primary-color)]/10 rounded-full">
              <Monitor size={40} className="text-[var(--primary-color)]" />
            </div>
        ...
        <div className="relative">
          <div className="flex flex-col gap-4 items-center px-8 py-30 shadow-xl hover:shadow-2xl text-center rounded-b-2xl">
            <div className="flex items-center justify-center w-16 h-16 bg-[var(--primary-color)]/10 rounded-full">
              <Award size={40} className="text-[var(--primary-color)]" />
            </div>
