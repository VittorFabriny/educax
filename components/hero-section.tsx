...
export function HeroSection() {
  return (
    <main className="px-5 lg:px-20 py-20 bg-(--color-bg)">
      <div className="sectionwrapper flex flex-col items-center justify-center gap-20 md:flex-row">
        <section className="flex flex-col gap-6 pt-20">
          ...
          <p className="text-xl text-(--color-text-muted) text-pretty leading-relaxed">
          ...
          <div className="flex items-center gap-10 mt-4">
            <div className="flex flex-col items-center">
              <span className="text-2xl font-bold text-(--primary-color)">50k+</span>
              <span className="text-sm">Alunos ativos</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-2xl font-bold text-(--primary-color)">200+</span>
              <span className="text-sm">Cursos disponíveis</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-2xl font-bold text-(--primary-color)">95%</span>
              <span className="text-sm">Satisfação</span>
            </div>
          </div>
        </section>
        <section className="w-auto mt-10 p-12 bg-linear-to-br from-[(--primary-color)/5 to-[(--secondary-color)/5 rounded-4xl">
          <Image
            src="/hero-image.jpg"
