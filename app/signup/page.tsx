...
export default function SignUp() {
  const { register, authLoading, error, success } = useAuth();
        ...
        {success ? (
          <section className="w-full">
            <div className="flex flex-col items-center justify-center gap-2 mb-10">
              <h1 className="text-2xl font-semibold">Conta criada com sucesso</h1>
            </div>

            <LoadingSpinner />
            <p className="text-center mt-6 text-sm">Redirecionando ao login</p>
          </section>
        ) : (
          <section className="w-full">
            <div className="flex flex-col items-center justify-center gap-2 mb-10">
            ...
            <form className="flex flex-col w-full gap-2" onSubmit={handleSubmit}>
              ...
              {error && <p className="text-center text-red-500 text-sm mt-5">{error}</p>}
              ...
              <div className="flex flex-col items-center gap-8 mt-5">
                ...
                <Link href="/login" className="focus:outline-(--primary-color)">
                  <p className="text-sm">
                    Já possui uma conta ?{' '}
                    <span className="text-(--primary-color)">Fazer login</span>
                  </p>
                </Link>
              </div>
            </form>
