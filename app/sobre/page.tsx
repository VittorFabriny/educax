...
const aboutValues = [
  {
    title: 'Missão',
    description:
      'Tornar o aprendizado acessível a todos, em qualquer lugar, democratizando o conhecimento através da tecnologia.',
    icon: Target,
    variant: 'primary',
  },
  {
    title: 'Visão',
    description:
      'Ser a principal referência em educação digital no país, inspirando transformações na vida de milhões de pessoas.',
    icon: Eye,
    variant: 'secondary',
  },
  {
    title: 'Valores',
    description:
      'Compromisso, transparência, acessibilidade e inovação guiam todas as nossas decisões e ações.',
    icon: Heart,
    variant: 'accent',
  },
] as const;
          ...
          <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-8">
            {aboutValues.map((values) => (
              <StepCard
                key={values.title}
                {...values}
                className="lg:items-start lg:text-left h-80"
              />
            ))}
          </div>
        </div>
        ...
        <div className="w-full mx-5 lg:mx-20 py-20 max-w-444 ">
          <div className="flex flex-col xl:flex-row items-center justify-between gap-10">
            <div className="flex flex-col gap-2 w-full">
              ...
              <p>
                A EducaX nasceu em 2020 com uma missão clara: tornar a educação de qualidade
                acessível para todos. Percebemos que muitas pessoas enfrentavam barreiras para
                desenvolver novas habilidades, seja por falta de tempo, recursos ou acesso a
                instituições tradicionais.
              </p>
              <p>
                Com uma equipe apaixonada por educação e tecnologia, começamos a desenvolver uma
                plataforma que permitisse que qualquer pessoa, em qualquer lugar, pudesse aprender
                no seu próprio ritmo. Desde então, já impactamos a vida de milhares de estudantes.
              </p>
              <p>
                Hoje, a EducaX oferece mais de 50 cursos em diversas áreas do conhecimento, contando
                com instrutores especialistas e uma comunidade ativa de mais de 12 mil alunos. Nossa
                jornada é impulsionada pelo compromisso de transformar vidas através da educação.
              </p>
            </div>
            <Image
              src="/diverse-online-learners.png"
              alt="Imagem nossa historia"
              width={400}
              height={400}
              className="object-cover rounded-2xl shadow-xl w-full"
            />
          </div>
        </div>
      </div>
      ...
      <section className="px-5 lg:px-20 py-28 bg-(--color-bg)">
        <div className="flex flex-col md:flex-row items-center justify-center gap-20">
          <div className="flex flex-col gap-6 text-center">
            ...
            <div>
              <p className="text-lg md:text-xl text-muted-foreground text-balance max-w-2xl mx-auto leading-relaxed">
                Combinamos tecnologia, qualidade e experiência para oferecer a melhor jornada de
                aprendizado
              </p>
            </div>
          </div>
      ...
      <section>
        <div className="mx-5 lg:mx-20 py-20">
          <div className="flex flex-col items-center justify-center gap-4 bg-(--secondary-color)/5 py-10 border border-black/5 rounded-3xl">
            ...
            <p className="mx-5">
              Tem alguma dúvida ou sugestão? Estamos sempre prontos para ouvir você e melhorar a sua
              experiência.
            </p>
            <a href="mailto:fabrinyvittor@gmail.com" className="text-(--primary-color)">
              fabrinyvittor@gmail.com
            </a>
          </div>
        </div>
      </section>
