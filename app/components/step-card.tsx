...
export function StepCard({
  ...
  return (
    <div
      className={`relative flex flex-col w-full gap-4 items-center px-8 py-10 shadow-xl hover:shadow-2xl text-center rounded-2xl border border-black/10 ${colors.hover} ${colors.bg} ${className}`}
    >
