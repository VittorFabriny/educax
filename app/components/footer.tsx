...
export function Footer() {
  return (
    <footer className="flex flex-col items-center justify-center bg-(--color-text-secondary) text-white p-4">
      <div className="w-full mx-5 lg:mx-20 max-w-444 py-5 pt-10">
        <div className="flex flex-col gap-10">
          <div className="w-full flex items-center justify-between">
            <div className="w-full flex flex-col gap-4 items-center justify-center ">
              <Logo path="/" />
              <p className="hidden md:block text-pretty max-w-100">
                Transformando vidas através da educação online. Aprenda novas habilidades e
                impulsione sua carreira com os melhores cursos do mercado.
              </p>
            </div>
