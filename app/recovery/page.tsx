        ...
        {success ?
          (
            <section className='w-full'>
              ...
              <Link href="/login" className='flex items-center justify-center gap-2 mt-8 focus:outline-(--primary-color) ' onClick={() => setSuccess(false)}>
          ...
          (
            <section className='w-full'>
              ...
              <form className='flex flex-col w-full' onSubmit={handleRecovery}>
                <Input label='Email' id="email" type='email' placeholder='seu@email.com' onChange={(e) => setEmail(e.target.value)} />
                ...
                <div className="flex flex-col items-center gap-8 mt-8">
                  ...
                  <Button title="Enviar link de recuperação" variant="primary" className='w-full justify-center' type='submit' />
                  <Link href="/login" className='flex items-center justify-center gap-2 focus:outline-(--primary-color)'>
                    <ArrowLeft size={20} className='text-black/20' onClick={() => setSuccess(false)} />
                    <p className="text-sm text-black/50">Voltar para o login</p>
                  </Link>
                </div>
